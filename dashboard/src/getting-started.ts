...
export async function getClientChecklist(user: User, env: Env): Promise<ChecklistStep[]> {
  ...
  const steps: ChecklistStep[] = [
    ...
    },
    {
      ...
      desc: "Generate suggested prompts based on your business, then one-click track the ones worth monitoring weekly across ChatGPT, Perplexity, Claude, Gemini, Google AI Overviews, and Gemma, read against Bing organic as a classic-search control.",
      href: `/discover/${slug}`,
