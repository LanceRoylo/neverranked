...
const GLOSSARY: GlossaryItem[] = [
  ...
  },
  {
    term: "Citation share",
    definition:
      "When we run a fixed set of questions about your industry through ChatGPT, Perplexity, Claude, Gemini, Google AI Overviews, and Gemma, read against Bing organic as a classic-search control, what percentage of the answers cite your site. 10% means one in ten answers names you. 0% means you are not yet in the conversation.",
  },
  {
    term: "Red flags",
    definition:
...
const SCHEDULE = [
  ...
  },
  {
    ...
    detail:
      "Full site scan for every tracked domain, citation run across ChatGPT, Perplexity, Claude, Gemini, Google AI Overviews, and Gemma, read against Bing organic as a classic-search control, Search Console data pull, regression alerts if any score dropped significantly, and the Monday morning brief email to any user who opted in.",
  },
  {
