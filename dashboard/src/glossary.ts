...
const GLOSSARY: GlossaryItem[] = [
  ...
  },
  {
    term: "Citation share",
    definition:
      "When we run a fixed set of questions about your industry through ChatGPT, Perplexity, Claude, Gemini, Microsoft Copilot, Google AI Overviews, and Gemma, what percentage of the answers cite your site. 10% means one in ten answers names you. 0% means you are not yet in the conversation.",
  },
  {
    term: "Red flags",
    definition:
...
const SCHEDULE = [
  ...
  },
  {
    ...
    detail:
      "Full site scan for every tracked domain, citation run across ChatGPT, Perplexity, Claude, Gemini, Microsoft Copilot, Google AI Overviews, and Gemma, Search Console data pull, regression alerts if any score dropped significantly, and the Monday morning brief email to any user who opted in.",
  },
  {
