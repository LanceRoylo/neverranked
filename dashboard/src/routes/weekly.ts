...
<main style="max-width:760px;margin:0 auto;padding:64px 24px">
  <header style="margin-bottom:48px">
    ...
    <p style="color:var(--text-mute);font-size:15px;line-height:1.6;margin-top:16px;max-width:600px">Anonymized observations from across our tracked clients on what AI engines (ChatGPT, Perplexity, Claude, Gemini, Google AIO, Gemma) are citing, what's surging on Reddit, and where the share is shifting. Published Fridays.</p>
  </header>
