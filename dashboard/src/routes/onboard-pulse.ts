    ...
    return html(layout("Onboarding complete", `
      <div style="max-width:560px;margin:80px auto;padding:24px;text-align:center">
        ...
        <p style="font-size:15px;line-height:1.7;color:var(--text-mute);margin:0 0 28px 0;max-width:440px;margin-left:auto;margin-right:auto">
          We're running your first citation scan now across ChatGPT, Perplexity, Claude, Gemini, Google AI Overviews, and Gemma, read against Bing organic as a classic-search control. Initial results land in your dashboard within a few hours. Your first monthly Visibility Index PDF arrives the first business day of next month.
        </p>
