  ...
  const clientSidebar = !isAgencyAdmin && user ? `
    <nav class="sidebar" id="sidebar" aria-label="Primary">
      ...
      <div class="sidebar-section collapsible" data-section="ops">
        ...
        <a href="/admin/graduation" class="sidebar-item${title === 'Graduation tracker' ? ' active' : ''}" title="Go-live scoreboard for the deliverable judge gate">Graduation</a>
        ...
        <div class="sidebar-overflow">
          ...
          <a href="/admin/warm-prospects" class="sidebar-item${active('Warm prospects')}" title="Outreach prospects ranked by signal tier with voice-clean follow-up drafts">Warm prospects</a>
  ...
  const avatarMenu = user
    ? `<details class="avatar-menu">
        ...
        <div class="avatar-panel" role="menu">
          ...
          <a href="/onboarding/checklist/reset" role="menuitem">Getting started</a>
