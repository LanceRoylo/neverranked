...
<div class="page">
  ...
  <!-- FOOTER -->
  <div class="footer">
    <div class="meta"><strong>Methodology.</strong> ${report.prompts_evaluated} prompts queried across ChatGPT, Perplexity, Claude, Gemini, Microsoft Copilot, Google AI Overviews, and Gemma. Citation share computed as % of prompts where the client name or domain appears in the engine's response. AI Presence Score weights: citation rate (50), engine spread (30), sentiment (20). Sample size disciplined: percentages hidden below n=10 mentions.</div>
